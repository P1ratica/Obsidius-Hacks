...
public class BlockListMineCommand extends Module {
    ...
    public BlockListMineCommand() {
        super(ObsidiusClient.CATEGORY,"BlockList#MineCommand", "Adds a custom #mine command to your message history containing all the blocks in the blocklist that are in the chunk you are in. Press T then up arrow, then ENTER key to execute the command. BETTER CHAT module is recommended for infinitely long commands.");
    }
    @Override
