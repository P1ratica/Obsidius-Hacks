...
import obsidiusdevelopment.obsidiusclient.utils.ObsidiusUtils;
...
public class ZKillaura extends Module {
    ...
    public ZKillaura() {
        super(ObsidiusClient.CATEGORY, "z-kill-aura", "Killaura which only attacks target if you aim at it.");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        HitResult hitResult = ObsidiusUtils.getCrosshairTarget(mc.player, range.get(), ignoreWalls.get(), (e -> !e.isSpectator()
            && e.canHit()
