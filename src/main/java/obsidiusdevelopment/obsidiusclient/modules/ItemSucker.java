...
import obsidiusdevelopment.obsidiusclient.utils.baritone.ObsidiusBaritoneUtils;
...
public class ItemSucker extends Module {
    ...
    int timer = 0;
    Vec3d startPos = null;
    ObsidiusBaritoneUtils baritoneUtils = new ObsidiusBaritoneUtils();

    public ItemSucker() {
        super(ObsidiusClient.CATEGORY, "item-sucker", "Automatically collects items on the ground");
    }
