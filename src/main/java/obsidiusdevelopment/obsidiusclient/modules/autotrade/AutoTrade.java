...
import obsidiusdevelopment.obsidiusclient.gui.screens.OfferScreen;
...
import obsidiusdevelopment.obsidiusclient.utils.config.ObsidiusConfigManager;

import java.util.ArrayList;
import java.util.List;

import static obsidiusdevelopment.obsidiusclient.ObsidiusClient.*;
...
public class AutoTrade extends Module {
    ...
    public AutoTrade() {
        super(ObsidiusClient.CATEGORY, "auto-trade", "Automatically trades items with villagers.");
    }
    ...
    public void fillWidget(GuiTheme theme, WVerticalList list) {
        ...
        ObsidiusConfigManager.configManager(theme, list, this);
    }
